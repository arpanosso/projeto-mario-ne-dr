...
# GERAR A MULTIVARIADA PARA CADA FAZENDA FOCANDO NAS ZEM

rodar a pca e o cluster para cada uma dessas fazendas buscando zonas
especificas de manejo…
...
# )
importance <- vip(tch_nn_last_fit_model) |> 
...
importance |> 
  ...
  geom_col(color="black", fill="orange2") +
  theme_bw()+
